...
public class continueOldCipher extends AppCompatActivity implements ReaderCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AddhunoButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                if (Addhuno.getText().toString().matches("")) {
                    Toast.makeText(continueOldCipher.this, "Please Add Hu No", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (gunlist.size() >=1)
                {
                    ...
                    Toast.makeText(continueOldCipher.this, "Hu Already Scanned", Toast.LENGTH_SHORT).show();
                    Addhuno.setText("");
                }
                else {
        ...
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(continueOldCipher.this, "No Data To Save", Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    Toast.makeText(continueOldCipher.this, "Saved Successfully", Toast.LENGTH_SHORT).show();
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    Toast.makeText(continueOldCipher.this, "New HuNo Added Successfully", Toast.LENGTH_SHORT).show();
                    Addhuno.setText("");
                    textcount.setText(String.valueOf(count+1));
...
//                e1.setText(myReaderType.toString());
    ...
    public class ExportRecievedCSV extends AsyncTask<String, Void, Boolean> {
        ...
        private final ProgressDialog dialog = new ProgressDialog(continueOldCipher.this);
        ...
        protected void onPreExecute() {
            ...
            this.dialog.show();
            dbhelper = new DBController(continueOldCipher.this);
        }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Toast.makeText(continueOldCipher.this, "Export successful!", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(continueOldCipher.this, "No Hu Recieved", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public class ExportExcessCSV extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Toast.makeText(continueOldCipher.this, " ExcessFile Export successful!", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(continueOldCipher.this, "No Excess File", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public class ExportShortCSV extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Toast.makeText(continueOldCipher.this, "ShortFile Export successful!", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(continueOldCipher.this, "No Short File", Toast.LENGTH_SHORT).show();
            }
        }
...
//            } else {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Toast.makeText(continueOldCipher.this, "Total Hu No File export successful!", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(continueOldCipher.this, "No File Export", Toast.LENGTH_SHORT).show();
            }
        }
